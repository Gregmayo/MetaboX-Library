 ...
 */
namespace MetaboX\Quantitative;

class CSV{
	protected $_delimiter;
	protected $_csvstring;
	
	protected $_nodes;
	protected $_data;
	
	public function __construct($csv_string, $delimiter = ','){
		$this->_csvstring = $csv_string;
