...
deleteCacheFolder('cache/resources/compounds/*');
echo "Compounds cache deleted.\n";

deleteCacheFolder('cache/resources/reactions/*');
echo "Reactions cache deleted.\n";

deleteCacheFolder('cache/resources/enzymes/*');
echo "Enzymes cache deleted.\n";

deleteCacheFolder('cache/resources/pathways/*');
echo "Pathways cache deleted.\n";
